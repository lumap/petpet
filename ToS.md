...
These Terms of Service ("Terms", "ToS", "Policy") are a legal agreement between PetPet Bot ("we", "us") and you, the user. By using any of our Services ("Service", "Product"), you agree that you have read, understood, and accepted to be bound by these Terms. If you are under the age of majority in your jurisdiction, you need to have your legal guardian review and agree to these Terms in order to use our Service.

We reserve the right to update these Terms at any point in time, to add, modify or remove legal requirements. If the aforementioned changes affect your usage of our Products, we will notify you at least seven days prior to those changes taking effect. Unless stated otherwise, continuing to use the Service after modifications to the Terms will display your agreement and acceptance to those changes.

## Discord Bot

We keep the right to exclude you from current and future use of the Bot and associated Services for reasons like, but not limited to: intentionally spamming our Services. We cannot be held responsible to any harm done to your Discord Server. Use the bot at your own risk and make sure to give minimal permissions in order to reduce potential risks.
